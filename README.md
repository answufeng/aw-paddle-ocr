...
**当前发布版本**：`1.0.9`（通过 [JitPack](https://jitpack.io/#answufeng/aw-paddle-ocr/1.0.9) 按 tag 拉取）。
...
```kotlin
dependencies {
    implementation("com.github.answufeng:aw-paddle-ocr:1.0.9")
}
```

也可将 `1.0.9` 换为其它 [tag](https://github.com/answufeng/aw-paddle-ocr/tags) 或 commit hash；构建结果以 [JitPack 构建页](https://jitpack.io/#answufeng/aw-paddle-ocr) 为准。
